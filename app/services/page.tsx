...
export default function ServicesPage() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-16 hero animate">
      ...
      {/* Fő szolgáltatás-kártyák – KÉPEKKEL + RÉSZLETES LEÍRÁSOK */}
        ...
        <article className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#2A1F2C]/70 via-[#241B27]/80 to-[#1B1520]/90 p-6 md:p-7">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-white/75 leading-relaxed text-sm md:text-base">
              ...
              biztonságos jelenlétben kísérlek, hogy újra legyen tér a belső csendre.
            </p>
        ...
        <article className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#2A1F2C]/70 via-[#241B27]/80 to-[#1B1520]/90 p-6 md:p-7">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-white/75 leading-relaxed text-sm md:text-base">
              ...
              Nem csodaszerekben gondolkodunk, hanem egy finomra hangolt, átlátható rendszerben.
            </p>
            <ul className="mt-4 text-white/70 space-y-1 text-sm">
        ...
        <article className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#2A1F2C]/70 via-[#241B27]/80 to-[#1B1520]/90 p-6 md:p-7">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-white/75 leading-relaxed text-sm md:text-base">
              ...
              otthon is végezhető gyakorlatokat kapsz, amelyek a hétköznapokban is támaszt adnak.
            </p>
            <ul className="mt-4 text-white/70 space-y-1 text-sm">
        ...
        <article className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#2A1F2C]/70 via-[#241B27]/80 to-[#1B1520]/90 p-6 md:p-7">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-white/75 leading-relaxed text-sm md:text-base">
              ...
              csak olyan lépések, amelyek illenek az életedhez és a terhelhetőségedhez.
            </p>
            <ul className="mt-4 text-white/70 space-y-1 text-sm">
